...
gcloud compute instances create instance-pretrain-on-test \
    ...
    --create-disk=auto-delete=yes,boot=yes,device-name=instance-pretrain-on-test,image=projects/debian-cloud/global/images/debian-12-bookworm-v20240515,mode=rw,size=80,type=projects/virtual-equator-423819-v6/zones/us-central1-a/diskTypes/pd-balanced \
